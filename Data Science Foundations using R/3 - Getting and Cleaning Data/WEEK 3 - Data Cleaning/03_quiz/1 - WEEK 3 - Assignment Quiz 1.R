...
download.file("https://d396qusza40orc.cloudfront.net/getdata%2Fdata%2Fss06hid.csv", destfile = "./getdata-ss06hid.csv")

# Read data into data.frame
ACS <- read.csv("getdata-ss06hid.csv")

# read the code book to understand why 3 and 6
